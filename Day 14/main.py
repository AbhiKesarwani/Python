...
game_is_on = True
while game_is_on:
    compare_a = compare_b                                      #Lower question must be a next upper question
    compare_b = random.choice(data)
    while compare_a == compare_b:                               #removing duplicate question condition
        compare_b = random.choice(data)
    ...
    # comparing followers,game over condition and increasing score

    if more_follower.lower() == "a":
