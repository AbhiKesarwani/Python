...
for i in range(len(question_data)):
    print(f"Q{i+1}. {question_data[i]['text']}")
    user_input = input("Enter your answer (True/False): ")
    if user_input.lower() == question_data[i]["answer"].lower():
        score += 1
    else:
        print("Your answer is wrong.")
    print(f"Correct answer is {question_data[i]["answer"]}")
